...
cd Bureau_Etude
wget https://download2.gluonhq.com/openjfx/18.0.1/openjfx-18.0.1_osx-x64_bin-sdk.zip
unzip openjfx-18.0.1_osx-x64_bin-sdk.zip
rm openjfx-18.0.1_osx-x64_bin-sdk.zip
mv javafx-sdk-18.0.1 javafx-sdk_MacOs-18.0.1
current_work="$(pwd)"
JAVAFX_Dir="$current_work/JAVAFX/javafx-sdk_MacOs-18.0.1/lib"
